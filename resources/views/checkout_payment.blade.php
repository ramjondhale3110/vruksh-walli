...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-9">
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <form action="{{url('payment_details')}}" method="POST" id="form-id">
                            @csrf
                        <input type="hidden" name="cashondelivery" value="{{$cart[0]->new_id}}">
                            <button type="submit" id="cod-button"  onclick="document.getElementById('form-id').submit();" style=" border: none !important;">
                                <img src="{{asset('img/cod.png')}}" alt="" style="margin-top: 50px;width:350px;" >
                            </button>
                        </form>
                    </div><br>
                    <div class="row">
                     <img src="{{asset('img/cod.png')}}" alt="" style="margin-top: 50px;width:350px;">
                     <img src="{{asset('img/download.png')}}" alt="" style="width:350px;margin-top: 50px;height: 130px; margin-left: 70px;">
                 </div>
                 <div class="row">
                    <div class="col-md-6">
    ...
    //             /*if (response == 'login') {
    //                  window.location.href= "{{ url('payment_details') }}"+"/"+pro_id;
    //             }*/
