              ...
              <div class="form-group">
                ...
                <div class="select2-purple">
                  <select class="select2" multiple="multiple" data-placeholder="Select Attribute" data-dropdown-css-class="select2-purple" id="button1" name="attribute_name[]"  style="width: 100%;">
                    ...
                    <option id="" value="<?php echo e($att->attribute_name); ?>"><?php echo e($att->attribute_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
              </div>
...
<script>
 ...
 function getSubcategory(value){
   ...
   jQuery.ajax({
    url: "<?php echo e(url('/admin/subcategory/getsubcategory/')); ?>",
    method: 'POST',
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#button').change(function() {
      selection = $(this).val();
      switch (selection) {
        case '<?php echo e($att->attribute_id); ?>':
        $('#cardioyes').show();
      }
    });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelproject\resources\views/admin/product/add.blade.php ENDPATH**/ ?>